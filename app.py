...
# =============================================================================
    ...
    try:
        ...
        st.error("No hay datos suficientes para comparar.")
        st.stop()
    ...
    for r in rubros_items:
        ub = df_b[r] / df_b['Huevos Fértiles'] if df_b['Huevos Fértiles'] > 0 else 0
        ua = df_a[r] / df_a['Huevos Fértiles'] if df_a['Huevos Fértiles'] > 0 else 0
